...
### 🌐 网址导航
![网址导航预览](assets/screenshots/kuntab-10.png)
...
### 🌐 网址导航
- **分类导航面板**：支持多级分类（树状选择器）管理常用网站，主页快捷访问。
- **全局搜索整合**：首页搜索框完美接入网址导航数据检索，支持快捷过滤和结果来源区分（书签 vs. 导航）。
- **便捷管理与配置**：支持添加、编辑、删除网站及分类，提供更高级的视觉交互和快捷空分类清理。
- **社交入口**：导航页支持一键加入 Telegram 官方群组。
